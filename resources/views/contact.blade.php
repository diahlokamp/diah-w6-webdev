                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control focus-ring" id="nameInput"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                        <input type="email" class="form-control focus-ring" id="emailInput"
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <select class="form-select focus-ring" id="packageSelect"
                                ...
                                <div class="col-12">
                                    <div class="form-floating mb-4">
                                        <textarea class="form-control focus-ring" placeholder="Leave a message here" id="messageInput" style="height: 150px"
                                            required></textarea>
                                ...
                                <div class="col-12 text-center">
                                    <button type="submit"
                                        class="btn btn-warning text-dark fw-bold btn-lg w-100 rounded-pill shadow-sm">Send
                                        Message</button>
                                </div>
                            </div>
                        </form>
